...
**Plans**: 4 plans (4 waves)
  - [ ] 03-01-PLAN.md — Wave 1: RED test stubs (test_extraction_agent.py, 6 functions) + docs/traces/ directory
  - [ ] 03-02-PLAN.md — Wave 2: ExtractionResult schema flesh-out (LineItemExtraction, D-01..D-05, D-05 vendor_name fix) + codegen drift-check
...
| 3. Extraction Agent | 0/4 | Not started | - |
