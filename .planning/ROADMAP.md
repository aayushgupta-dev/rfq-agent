...
**Plans**: 4 plans (2 waves)
  - [ ] 01-01-PLAN.md — Monorepo scaffold (relocate Python to services/ai, pnpm+turbo workspace, apps/web shell, shared-types pkg) + dev tooling spine (ruff/pytest, prettier/eslint)
...
**Plans**: TBD
**Research**: yes — OpenAI strict structured-output edge cases (truncation/refusal, schema-splitting when 8 line items × fields × evidence strain limits) and LangGraph v2 stream-mode → SSE mapping are the highest-novelty integration points. Plan with `--research-phase`.
